...
<head>
  <meta charset="utf-8">
  <title>Starmovies-Homepage</title>
  ...
  <body>
    <header>
        ...
        <nav class="navbar navbar-expand-md navbar-dark bg-dark ">
            <a href="user-login.php" class="navbar-brand"> <img src="images/star.png" alt=""> </a>
            ...
            <ul class="navbar-nav">
              ...
              if (isset($_SESSION['id'])) {
                if ($_SESSION['id'] == 1) {
                  ...
                  // echo "<li class='nav-item'> <a href='delmovie.php' class='nav-link'>Delete movie</a> </li>";
